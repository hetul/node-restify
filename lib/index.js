...
function createServer(options) {
    ...
    server.on('uncaughtException', function (req, res, route, e) {
        ...
        // In the event an exception was thrown and not caught, the domain
        // belonging to the active TCP connection will no longer be usable, the
        // client should create a new TCP connection on the next request.
